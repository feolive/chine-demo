            ...
            <div className="w-full lg:w-1/2 flex items-center flex-col justify-center pt-24 sm:pt-0">
              ...
              <div className="flex flex-wrap -m-2">
                ...
                <div className="w-full sm:w-4/5 p-2 mt-4 mx-auto">
                  <button
                    className="py-4 px-6 w-full text-primaryText font-semibold rounded-xl shadow-4xl focus:ring focus:ring-red-400 bg-primaryColor hover:bg-[#e63946] transition ease-in-out duration-200"
                    type="button"
                    aria-label="Join now"
                  >
                    Join Now

...
export const MenuItem = (food,order) => {
  ...
  return (
    ...
    initial={{ rotate: -5 }}
    whileInView={{ rotate: 0, transition: {type: "spring", bounce: 0.4, duration: 0.8} }}
    >
    <div className="w-[350px] sm:w-[380px] lg:w-1/3 px-4 mb-8 lg:mb-0">
      <div className="p-8 bg-bgDark3 rounded-3xl">
        ...
        <div className="flex justify-start items-end">
          ...
          <MinusIcon className="h-7 w-7 sm:h-8 sm:w-8 mr-2" onClick={decreaseAmount} />
          <div className="text-2xl sm:text-3xl font-bold text-primaryText text-left mr-2">
            {amount}
          </div>
          <PlusIcon className="h-7 w-7 sm:h-8 sm:w-8 mr-2" onClick={increaseAmount} />
        </div>
      </div>
    </div>
    </motion.div>
